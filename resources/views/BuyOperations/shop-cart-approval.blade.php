...
<head>
    <title>خرید دوره با موفقیت</title>
    <meta charset="utf-8">
                ...
                <div class="cart_totals">
                    ...
                    <table>
                        ...
                        <tr class="cart-subtotal">
                            <th><span class="amount">{{number_format($course->price)}}</span><span class="tooman">هزار تومان</span></th>
                            <td>قیمت</td>
                        </tr>
                        <tr class="order-total">
                            <th><span class="amount">{{$price}}<span class="tooman">هزار تومان</span></span></th>
                            <td>قیمت نهایی</td>
                        </tr>
                        <tr class="">
                            <th>
