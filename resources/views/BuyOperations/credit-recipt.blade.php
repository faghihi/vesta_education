    ...
    <div class="container clear-fix">
        <div id="content" role="main">
            <div class="banner-offer icon-right bg-color-2 final-message">
                ...
                <div class="banner-text" style="text-align: right">خرید با اعتبار با موفقیت انجام شد</div>
            </div>
                ...
                <div class="cart_totals">
                    ...
                    <table>
                        ...
                        <tr class="cart-subtotal">
                            ...
                            <td>مقدار پرداخت شده از اعتبار</td>
                        </tr>
                        <!--<tr class="shipping">-->
                        <!--<th>-->
                    ...
                    <a href="profile-v2.html" class="cws-button bt-color-3 border-radius alt">بازگشت به پروفایل</a>
                </div>
            </div>
        </div>
        <!--Shop -->
